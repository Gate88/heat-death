...
function nfig(settings){
    ...
    for(let i=0; i < 4; i++){
        default_bindings[`pad_generic:${i}:button:0:+`] = [i, "o"];
        default_bindings[`pad_generic:${i}:button:1:+`] = [i, "x"];
        ...
        default_bindings[`pad_standard:${i}:button:0:+`] = [i, "o"];
        default_bindings[`pad_standard:${i}:button:1:+`] = [i, "x"];
        default_bindings[`pad_standard:${i}:button:2:+`] = [i, "x"];
        default_bindings[`pad_standard:${i}:button:3:+`] = [i, "o"];
    ...
    css.rel="stylesheet";
    css.href="data:text/css;base64,";
